export default function ContactHeader() {
  return (
    <div className="relative overflow-hidden bg-[url('/getin.avif')] bg-cover bg-center min-h-[290px] md:min-h-[340px] flex items-center text-center border-b border-zinc-200">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 md:py-12">
        ...
        <p className="text-zinc-100/95 max-w-2xl mx-auto text-sm md:text-base drop-shadow-[0_1px_4px_rgba(0,0,0,0.5)]">
          Have a question or ready to place a wholesale order? We&apos;d love to hear from you.
        </p>
      </div>
    </div>
  );
