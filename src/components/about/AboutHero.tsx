export default function AboutHero() {
  return (
    <div className="relative overflow-hidden bg-[url('/about.png')] bg-cover bg-center min-h-[290px] md:min-h-[340px] flex items-center text-center border-b border-zinc-200">
