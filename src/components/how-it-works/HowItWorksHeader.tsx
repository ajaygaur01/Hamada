export default function HowItWorksHeader() {
  return (
    <div
      id="how-it-works"
      className="relative overflow-hidden bg-[url('/how.avif')] bg-cover bg-center min-h-[290px] md:min-h-[340px] flex items-center text-center border-b border-zinc-200 scroll-mt-20"
    >
